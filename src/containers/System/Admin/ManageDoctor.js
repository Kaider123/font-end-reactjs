                ...
                <div className='more-info'>
                    ...
                    <div className='content-right'>
                        ...
                        <textarea className='form-control' rows='4'
                            onChange={(event) => this.hadleOnChangeText(event, 'description')}
                ...
                <div className='more-info-extra row'>
                    ...
                    <div className='col-4 form-group'>
                        ...
                        <input className='form-control'
                            onChange={(event) => this.hadleOnChangeText(event, 'nameClinic')}
                    ...
                    <div className='col-4 form-group'>
                        ...
                        <input className='form-control'
                            onChange={(event) => this.hadleOnChangeText(event, 'addressClinic')}
                    ...
                    <div className='col-4 form-group'>
                        ...
                        <input className='form-control'
                            onChange={(event) => this.hadleOnChangeText(event, 'note')}
